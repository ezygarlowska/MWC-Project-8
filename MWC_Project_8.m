...
subplot(3,1,2);
plot(x(1:2472),QX); 
ylabel('d Q_s_,_x/d x  [m/s]','FontWeight','bold');
xlabel('x [m]','FontWeight','bold');
...
title('Volumetric net transport per unit width in x-direction','FontWeight','bold');
legend('Ux=0','Ux');
title('Effect of undertow on sediment transport','FontWeight','bold');
xlim([4000 5000]);
...
hold on;
plot(x(1:2472),Qsyn);
ylabel('Q_s_y [m^2/s]','FontWeight','bold');
xlabel('x [m]','FontWeight','bold');
title('Volumetric net transport per unit width in x-direction','FontWeight','bold');
legend('Ux=0','Ux');
title('Effect of undertow on sediment transport','FontWeight','bold');
...
hold on;
plot(x(1:2472),QXn);
ylabel('X gradient of Q_s_x [m^2/s]','FontWeight','bold');
xlabel('x [m]','FontWeight','bold');
title('Volumetric net transport per unit width in x-direction','FontWeight','bold');
legend('Ux=0','Ux');
title('X gradient of Q_s_x','FontWeight','bold');
xlim([4000 5000]);
savefig('Matlab8_6');
...
ylabel('z [m]','FontWeight','bold');
xlabel('x [m]','FontWeight','bold');
legend('Z(t=0)','Z(t=10 days)','Z(t=10 days) with undertow');
title('Time evolution of the seabed','FontWeight','bold');
xlim([4000 5000]);
savefig('Matlab8_7');
...
%% Small waves 
% Half wave height offshore 
Hrms0s=0.5*Hrms0;
waves=BJmodel(Hrms0s,T0,Zeta,theta0,profile,hmin);
...
%Computing undertow 
rho=1000; %Water density [kg/m^3]
E=waves.E; %Wave energy
Er=waves.Er; %Wave energy roller
c=waves.c; %Wave celerity 
Ux=undertow(E(1:2472),Er(1:2472),c(1:2472),ht(1:2472),rho,Hrms(1:2472));
Ux=Ux*100; %in cm/s
...
xlabel('x [m]','FontWeight','bold');
%title('Volumetric net transport per unit width in x-direction','FontWeight','bold');
legend('0.5*Hrms', 'Normal conditions');
title('Effect of wave height on sediment transport','FontWeight','bold');
xlim([4000 5000]);
...
ylabel('z [m]','FontWeight','bold');
xlabel('x [m]','FontWeight','bold');
legend('Z(t=0)','Z(t=10 days) 0.5*Hrms','Z(t=10 days)');
title('Time evolution of the seabed','FontWeight','bold');
xlim([4000 5000]);
savefig('Matlab8_10');

%% Large waves 
% Double wave height offshore 
Hrms0l=2*Hrms0;
waves=BJmodel(Hrms0l,T0,Zeta,theta0,profile,hmin);
...
xlabel('x [m]','FontWeight','bold');
%title('Volumetric net transport per unit width in x-direction','FontWeight','bold');
legend('2*Hrms', 'Normal conditions');
title('Effect of wave height on sediment transport','FontWeight','bold');
xlim([4000 5000]);
...
hold on;
plot(x(1:2472),QXn);
ylabel('X graient of Q_s_x [m^2/s]','FontWeight','bold');
xlabel('x [m]','FontWeight','bold');
title('Volumetric net transport per unit width in x-direction','FontWeight','bold');
legend('2*Hrms', 'Normal conditions');
title('X gradient of Q_s_x','FontWeight','bold');
...
ylabel('z [m]','FontWeight','bold');
xlabel('x [m]','FontWeight','bold');
legend('Z(t=0)','Z(t=10 days) 2*Hrms','Z(t=10 days)');
title('Time evolution of the seabed','FontWeight','bold');
xlim([4000 5000]);
savefig('Matlab8_13');
...
title('Effect of ripples on sediment transport','FontWeight','bold');
xlim([4000 5000]);
...
ylabel('z [m]','FontWeight','bold');
xlabel('x [m]','FontWeight','bold');
legend('Z(t=0)','Z(t=10 days)','Z(t=10 days) with ripples');
title('Time evolution of the seabed','FontWeight','bold');
xlim([4000 5000]);
savefig('Matlab8_16');